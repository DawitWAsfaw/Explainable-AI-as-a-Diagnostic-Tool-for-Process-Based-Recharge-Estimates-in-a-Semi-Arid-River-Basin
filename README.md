...
The over all description of the project is summarized in [Description]() and in step by step guide on how to run the Python scripts in Steps. The models are built using Anaconda environment. The libraries used are listed in Dependencies file and can be installed on local computer by copying the code snippet provided below.
# Method workflow
![image](https://github.com/DawitWAsfaw/Groundwater-ML-Estimates/assets/89609490/bd0b6f3a-8d78-4303-840e-d21d0384d071)
# Spatial prediction
![image](https://github.com/DawitWAsfaw/groundwater_recharge_estimates_using_ML/blob/main/Figure%207.%20spatial%20prediction.png](https://github.com/DawitWAsfaw/groundwater_recharge_estimates_using_ML/blob/main/Figure%203.%20Methods%20Flow%20Chart.png)

# High recharge zones
![image](https://github.com/DawitWAsfaw/groundwater_recharge_estimates_using_ML/blob/main/Figure%208.%20High%20Recharge%20Zones.png)
# Affiliations
![image](https://github.com/DawitWAsfaw/groundwater_recharge_estimates_using_ML/blob/main/affiliations.png)
