...
def create_corr_heatmap_of__open_source_predictor_variables(ml_input_all_df,eda_plots_path):
    ...
    corr_col_rename ={
                    ...
                    'Maximum Air Temperature':17,  'Minimum Air Temperature ':18,
                     ...
                     'Grassland Or Herbaceous':22,'Cultivated Crops':23,'Emergent Herbaceous Wetlands':24,
              
                     'Hydraulic Conductivity':25,  'Specific Yield':26, 'Depth to Water Table':27,  
                     'Aquifer Thickness':28,  'Recharge':29
                     }
    text_label_list = []
    ...
    renaming_dic = { 
                  'distanceTo_stream':'Distance to stream', 
                  'drainage_density': 'Drainage Density',  
                  'TRI': 'Topographic Roughness Index',  
                  'TWI':'Topographic Wetness Index',  
                  'SPI':'Stream Power Index',  
                  ...
                  'cultivatedCrops':'Cultivated Crops',  
                  'woodyWetlands':'Woody Wet Lands',  
                  'emergentHerbaceousWetlands': 'Emergent Herbaceous Wetlands', 
                  'k_mday':'Hydraulic Conductivity',  
                  'sy':'Specific Yield',  
                  'depth2Water_tbl':'Depth to Water Table',  
                  'thick_m' : 'Aquifer Thickness',
                  'recharge [mm/yr]':'Recharge'}
    ...
    variable_names = ['Distance to stream', 'Drainage Density', 'Topographic Roughness Index', 'Topographic Wetness Index', 
                      ...
                      'Grassland Or Herbaceous','Cultivated Crops','Emergent Herbaceous Wetlands',
                      'Hydraulic Conductivity',  'Specific Yield', 'Depth to Water Table',  'Aquifer Thickness','Recharge']
    ...
    for idx, text in zip(np.arange(3,20.5,0.5),text_label_list):
        print(idx, text )
        plt.text(19, idx, text, fontsize=20)
    ...
    ax.set_title("Pearson correlation heat map of stand-alone ML model input variables",fontdict = {'fontsize': 22,'fontweight': 'bold'})
    plt.tight_layout()
